...
import CenterMenu from '../scenes/center/centerMenu/centerMenu';
...
const MenuCenterStackScreen = ({navigation, user}) => (
  <MenuStack.Navigator initialRouteName='CenterMenu' screenOptions={options}>
    <MenuStack.Screen name="CenterMenu" 
      options={{ 
      ...
      {(props) => <CenterMenu {...props} user={user}/>}
    </MenuStack.Screen>
