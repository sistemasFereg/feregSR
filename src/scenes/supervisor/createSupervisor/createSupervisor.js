...
class CreateSupervisor extends Component {
  ...
  componentDidMount() {
    if(this.props.supervisor) {
      this.setState({ supervisor: this.props.supervisor });
      this.setState({ name: this.props.supervisor.name });
      this.setState({ lastName: this.props.supervisor.lastName });
      this.setState({ superNum: this.props.supervisor.superNum });
    }
  }

  validate() {
    const {name, lastName, email, phone, superNum, password, passwordConfirm} = this.state;
  ...
  createUser() {
    ...
    firebase.firestore().collection("user").doc(`${this.state.email}`).set({
      ...
      Alert.alert("Fereg Sr","Supervisor creado exitosamente")
  ...
  render() {
    return (
      <SafeAreaView style={styles.container}>
        <CustomHeader title={'Crear Supervisor'}/>
        <ScrollView style={styles.scroll}>
          ...
          <Text style={styles.title}>Crear Supervisor</Text>
          ...
          <View style={styles.inputView} ref={r=>this.numInput=r}>
            <TextInput  
              style={styles.inputText}
              placeholder="Numero del supervisor" 
              placeholderTextColor={COLORS.black}
              onChangeText={text => this.setState({superNum:text})}
              value={this.state.superNum}
            />
          </View>
          {
            this.state.error
